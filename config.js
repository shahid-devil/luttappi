...
module.exports = {
    ...
    SESSION: process.env.LUTTAPPI_SESSION === undefined ? '' : process.env.LUTTAPPI_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    REMOVE: process.env.THERI_KICK_GP === undefined ? 'false' : process.env.THERI_KICK_GP,
    AFN: process.env.ALL_CAPTION === undefined ? 'MADE BY LUTTAPPI' : process.env.ALL_CAPTION,
    ALL_LINK_BAN: process.env.ALL_LINK_BAN === undefined ? 'false' : process.env.ALL_LINK_BAN,
    Z_LUTTAPPI_AI: process.env.Z_LUTTAPI_AI === undefined ? 'false' : process.env.Z_LUTTAPPI_AI,
    ...
    BOTSHAZZ: process.env.BOT_NAME === undefined ? 'LUTTAPPI BOT' : process.env.BOT_NAME,
