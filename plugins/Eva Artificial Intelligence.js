...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to luttappi voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional luttappi features. Turn your account into a ai chatbot!'
    already_on = 'luttappi artificial intelligence is already fully functional.'
    already_off = 'luttappi artificial intelligence is currently running semi-functional.'
    succ_on = 'luttappi Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'luttappi Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'AZ') {
